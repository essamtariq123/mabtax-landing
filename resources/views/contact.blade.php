            ...
            <div class="row">
                ...
                <div class="col-lg-6 offset-lg-3">
                    <div class="contact-form style-01">
                        <form action="{{ route('contact-us') }}" class="contact-page-form" method="POST">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="message" id="msg" cols="1" rows="4" placeholder="Type Query"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="contact_map">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3399.9485643482562!2d74.33667231515147!3d31.553026181358785!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391904c87c03f811%3A0xde393c60de69f2e6!2sShahrah-e-Quaid-e-Azam%2C%20Lahore%2C%20Punjab!5e0!3m2!1sen!2s!4v1643122764333!5m2!1sen!2s"
