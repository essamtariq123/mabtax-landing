                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                    style="mso-table-lspace:0;mso-table-rspace:0;font-weight:400;text-align:left;vertical-align:top;padding-top:100px;padding-bottom:0;border-top:0;border-right:0;border-bottom:0;border-left:0">
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="font-family:sans-serif">
                                                                    <div class
                                                                        style="font-size:14px;mso-line-height-alt:16.8px;color:#ff6661;line-height:1.2;font-family:Helvetica Neue,Helvetica,Arial,sans-serif">
                                                                        <p
                                                                            style="margin:0;font-size:14px;mso-line-height-alt:16.8px">
                                                                            <strong><span style="font-size:38px;">New Service Query</span></strong></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td class="pad">
                                                                <div style="font-family:sans-serif">
                                                                    <div class
                                                                        ...
                                                                        <p
                                                                            style="margin:0;font-size:14px;mso-line-height-alt:16.8px">
                                                                            <span style="font-size:16px;">Hey, we have received a new Query, please take a look.</span></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td class="pad">
                                                                <div style="font-family:sans-serif">
                                                                    <div class
                                                                        ...
                                                                        <p
                                                                            style="margin:0;font-size:14px;mso-line-height-alt:16.8px">
                                                                            <span style="font-size:14px;">Phone: <b>{{ $details['phone'] }}</b>
                                                                            {{-- <span style="font-size:14px;">Name: <b>{{ $details['name'] }}</b> --}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="pad">
                                                                <div style="font-family:sans-serif">
                                                                    <div class
                                                                        ...
                                                                        <p
                                                                            style="margin:0;font-size:14px;mso-line-height-alt:16.8px">
                                                                            <span style="font-size:14px;">Email: <b>{{ $details['email'] }}</b>
                                                                            {{-- <span style="font-size:14px;">Name: <b>{{ $details['name'] }}</b> --}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td class="pad">
                                                                <div style="font-family:sans-serif">
                                                                    <div class
                                                                        ...
                                                                        <p
                                                                            style="margin:0;font-size:14px;mso-line-height-alt:16.8px">
                                                                            <span style="font-size:14px;">Query: <b>{{ $details['query'] }}</b>
                                                                            {{-- <span style="font-size:14px;">Name: <b>{{ $details['name'] }}</b> --}}
                                                                        </p>
                                                                    </div>
                                                                </div>
