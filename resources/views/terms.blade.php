...
@section('content')
    ...
    <div class="contact-area padding-top-180 padding-bottom-120">
        <div class="container">
            <h1>Privacy Policy of Mabtax.com (MAB Consultants Pvt Ltd)</h1>

            <p>Mabtax.com (MAB Consultants Pvt Ltd) operates the www.mabtax.com website, which provides the SERVICE.</p>

            <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure
                of Personal Information if anyone decided to use our Service, the Mabtax.com website.</p>
            ...
            <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
                accessible at www.mabtax.com, unless otherwise defined in this Privacy Policy.</p>
